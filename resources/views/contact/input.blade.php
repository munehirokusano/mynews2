        ...
        <form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="course[]" id="check1" value="新体操コース">
                            <label class="form-check-label" for="check1">新体操コース</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="course[]" id="check2" value="体操コース">
                            <label class="form-check-label" for="check2">体操コース</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="course[]" id="check3" value="空手コース">
                            <label class="form-check-label" for="check3">空手コース</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="course[]" id="check4" value="クラシックバレエコース">
                            <label class="form-check-label" for="check4">クラシックバレエコース</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="course[]" id="check5" value="ダンスコース">
            ...
            <fieldset class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="area" id="radio1" value="宇都宮市">
                            <label class="form-check-label" for="radio1">宇都宮市</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="area" id="radio2" value="小山市">
                            <label class="form-check-label" for="radio2">小山市</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="area" id="radio3" value="真岡市">
                            <label class="form-check-label" for="radio3">真岡市</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="area" id="radio4" value="下野市">
                            <label class="form-check-label" for="radio4">下野市</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="area" id="radio5" value="栃木市">
                            <label class="form-check-label" for="radio5">栃木市</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="area" id="radio6" value="6">
                            <label class="form-check-label" for="radio6">その他地域</label>
                            <input type="text" name="text" class="form-control" id="inputother" value="">
                        </div>
                    </div>
                </div>
            </fieldset>
